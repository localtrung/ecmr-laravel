    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="uk-flex uk-flex-middle mb20">
                ...
                @endphp
                <a class="image img-cover system-flag" href="{{ $url }}">
            ...
            <div class="panel-description">
                ...
                <p>+ Bạn có thể thay đổi vị trí hiển thị bằng cách <span class="text-success">Kéo thả</span> menu đến vị
                    trí mong muốn </p>
                <p>+ Dễ dàng khởi tạo menu con bằng cách ấn vào nút <span class="text-success">Quản lý menu con</span>
                </p>
                <p><span class="text-danger">Hỗ trợ tối đa 5 cấp menu</span></p>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="ibox">
                <div class="ibox-title">
                    <div class=" uk-flex uk-flex-middle uk-flex-space-between">
                        ...
                        <a href="{{ route('menu.editMenu', ['id'=> $id]) }}" class="custon-button">Cập nhật menu cấp
                            1</a>
                    </div>
                </div>
