                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <select name="customer_catalogue_id" class="form-control setupSelect2">
                                        ...
                                        <option {{ 
                                            $val -> id == old('customer_catalogue_id', (isset($customer->customer_catalogue_id)) ? $customer->customer_catalogue_id : '') ? 'selected' : '' 
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <select name="source_id" class="form-control setupSelect2">
                                        ...
                                        @foreach($sources as $keySource => $item)
                                        <option {{ 
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="address"
                                        value="{{ old('addresss', ($customer->address) ?? '') }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
