            ...
            <div class="col-lg-6">
                <div class="form-row">
                    ...
                    <input type="text" name="name" value="{{ old('name', ($model->name) ?? '' ) }}" class="form-control"
                        placeholder="Nhập vào tên chương trình..." autocomplete="off">
                </div>
            </div>
            @endif
            <div class="col-lg-6">
                <div class="form-row">
                    ...
                    <input type="text" name="code" value="{{ old('code', ($model->code) ?? '' ) }}" class="form-control"
                        placeholder="Nếu mã khuyến mãi để trống hệ thống sẽ tự tạo" autocomplete="off">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-row mt10">
                    ...
                    <textarea name="description" placeholder="nhập vào mô tả khuyến mại..." class="form-control form-textarea" style="height: 100px;">
