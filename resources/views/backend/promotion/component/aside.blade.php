<div class="col-lg-4">
            ...
            <div class="form-row mb20">
                ...
                <div class="form-date">
                    <input type="text" name="endDate" value="{{ old('endDate', ($model->endDate) ?? '' ) }}"
                        ...
                        @if((old ('neverEndDate', ($model->neverEndDate ?? null)) ==
                    'accept'))
                    disabled
                    @endif
                    >
            ...
            <div class="setting-value">
                <div class="nav-setting-item uk-flex uk-flex-middle">
                    <input type="radio" name="source" value="all" id="allSource" class="chooseSource" checked="" {{
                        (old('source', $model->sourceStatus ?? '') ==='all' ||
                    !old('source')) ? 'checked' : '' }}
                    >
    ...
    <div class="ibox">
            ...
            <div class="setting-value">
                <div class="nav-setting-item uk-flex uk-flex-middle">
                    <input class="chosseApply" type="radio" name="applyStatus" value="all" id="allApply" checked {{
                        (old('applyStatus', $model->sourceStatus ?? '') ==='all'
                ...
                <div class="nav-setting-item uk-flex uk-flex-middle">
                    ...
                    {{ (old('applyStatus', $model->sourceStatus ?? '') ==='choose') ? 'checked' : '' }}
                    >
        ...
        @php
        $applyStatus = old('applySatus', ($model->applyStatus) ?? null);
