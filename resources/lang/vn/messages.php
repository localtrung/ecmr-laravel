...
return [
    ...
    'promotion' => [
        ...
        'create' => [
            ...
            'destroy' => 'Xóa Thông tin khuyến mại',
        ],
    ],
    'source' => [
        'index' => [
            'title' => 'Quản lý nguồn khách hàng',
            'table' => 'Danh sách nguồn khách hàng'
        ],
        'create' => [
            'title' => 'Thêm mới nguồn khách hàng',
            'destroy' => 'Xóa Thông tin nguồn khách hàng',
        ],
    ],
    'customer' => [
        'index' => [
        ...
        'create' => [
            ...
            'destroy' => 'Xóa Thông tin Khách hàng',
        ],
    ],
    'galleryCatalogue' => [
        'index' => [
