(function($) {
    ...
    HT.createVariantRow = (attributeItem, variantItem) => {
        ...
        let inputHiddenFields = [
            ...
            { name: 'variant[price][]', class: 'variant_price', value: $('input[name=price]').val() },
    ...
    HT.productVariant = () => {
        ...
        $('.variant-row').each(function(index, value){
            ...
            let inputHiddenFields = [
                ...
                { name: 'variant[file_name][]', class: 'variant_filename', value: variant.filename[index] },
                { name: 'variant[file_url][]', class: 'variant_fileurl', value: variant.fileUrl[index] },
